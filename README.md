# AI-CAPSTONE-PROJECT: Exploring APIs with Python – Fetching Real-Time Data
...
### Course: AI Essentials for Software Development
...
- Improve my data analysis workflows
...
How I fixed it: Printed the full JSON to understand structure

### Issue 2: API not responding
Problem: Incorrect API URL

How I fixed it: Verified endpoint from documentation

### Issue 3: JSON confusion
Problem: Didn’t understand nested data

How I fixed it: Used AI to explain JSON step-by-step
